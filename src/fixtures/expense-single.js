export const ExpenseSingleTestData = {
    description : 'A very special expense',
    note : 'This is a test note with §`weird cahrs.',
    amount : 66666,
    created : new Date()
};

export const ExpenseAlternateSingleTestData ={
